return {
    ...
    unlock_wh_captain_bw_crowbill           = { en = "Crowbill (Sienna)" },
    ...
    unlock_wh_bountyhunter_bw_crowbill      = { en = "Crowbill (Sienna)" },
    ...
    unlock_wh_zealot_bw_crowbill            = { en = "Crowbill (Sienna)" },
    ...
    unlock_wh_priest_bw_crowbill            = { en = "Crowbill (Sienna)" },
