...
local MOD_VERSION = "0.12.322-dev"
...
mod:dofile("scripts/mods/weapon_tweaker_dev/_wt_weapon_action_lifecycle")
...
local _wt_transform_runtime = mod:dofile(
    "scripts/mods/weapon_tweaker_dev/_wt_transform_runtime").install(mod, {
...
local _wt_cross_character_safety = mod:dofile(
    "scripts/mods/weapon_tweaker_dev/_wt_cross_character_safety").install(mod, {
        dbg = _dbg,
...
mod:dofile("scripts/mods/weapon_tweaker_dev/_wt_weapon_balance_patches")
...
mod:dofile("scripts/mods/weapon_tweaker_dev/_wt_moonfire_aoe")
...
mod:dofile("scripts/mods/weapon_tweaker_dev/_wt_ingame_3p_swap_owner")
...
mod:dofile("scripts/mods/weapon_tweaker_dev/_wt_menu_preview_owner")
...
mod:dofile("scripts/mods/weapon_tweaker_dev/_wt_settings_runtime").install({
    ...
    extra_batch = function(setting_ids)
        _wt_dev_anim_picker.on_settings_batch_changed(setting_ids)
        _wt_dev_hold_pose.on_settings_batch_changed(setting_ids)
    end,
