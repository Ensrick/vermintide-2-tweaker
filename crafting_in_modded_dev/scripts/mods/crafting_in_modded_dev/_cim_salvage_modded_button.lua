...
local core = mod:dofile("scripts/mods/crafting_in_modded_dev/_cim_salvage_autofill_core")
...
-- Singleton preflight 2026-07-14: no existing cim_dev hooks target either
