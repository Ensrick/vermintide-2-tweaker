...
-- ============================================================================
-- Full research: gui_tweaker/HERO_SELECT_RESEARCH_173.md (source-cited; updated
...
-- (this file and gui_tweaker.lua) --
-- gut registers ZERO hooks on CharacterSelectionView anywhere else. The two
