...
-- on_all_mods_loaded (chained, same pattern as gui_tweaker.lua) ONLY when the
...
M.armory_window = mod:dofile("scripts/mods/gui_tweaker/_ba_armory_window")
...
M.tabs = mod:dofile("scripts/mods/gui_tweaker/_ba_compendium_tabs")
