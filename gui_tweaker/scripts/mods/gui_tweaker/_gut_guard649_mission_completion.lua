...
--
-- Owned by: gui_tweaker.lua. Consumed via: ordered mod:dofile manifest.

local mod = get_mod("gut")
local Policy = mod:dofile("scripts/mods/gui_tweaker/_gut_mission_completion_policy")
...
-- Hook preflight 2026-07-16: this is gut's only hook on
