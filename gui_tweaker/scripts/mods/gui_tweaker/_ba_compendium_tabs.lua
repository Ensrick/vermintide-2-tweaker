...
-- gui_tweaker_localization.lua both because a vanilla widget needs a resolved
...
-- keys get added to gui_tweaker_localization.lua later they win automatically;
