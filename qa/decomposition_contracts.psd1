@{
    ...
    Contracts = @(
        ...
        @{
            ...
            CeilingLines = 8640
            RequiredModules = @('_ct_combat_hooks.lua', '_ct_boon_registry.lua', '_ct_boon_preview_helpers.lua', '_ct_boss_grudge_marks.lua', '_ct_bot_weapon_chest_owner.lua', '_ct_command_owner.lua', '_ct_curse_lighting_owner.lua', '_ct_journey_difficulty_guard.lua', '_ct_pickup_spawn_owner.lua', '_ct_spawn_eligibility_owner.lua', '_ct_weapon_trait_generation.lua', '_ct_regression.lua')
        }
        @{
