@{
    ...
    Contracts = @(
        ...
        @{
            ...
            CeilingLines = 6688
            RequiredModules = @('_cwv_variant_catalog.lua', '_cwv_core_templates.lua', '_cwv_skin_registry.lua', '_cwv_illusion_families.lua', '_cwv_husk_path.lua', '_cwv_musket_runtime.lua', '_cwv_husk_residency_owner.lua', '_cwv_regression_identity.lua', '_cwv_illusion_provenance.lua')
        }
        @{
