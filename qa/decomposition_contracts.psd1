@{
    ...
    Contracts = @(
        ...
        @{
            ...
            CeilingLines = 3067
            RequiredModules = @('_cim_forge_preview.lua', '_cim_forge_preview_owner.lua', '_cim_forge_picker_owner.lua', '_cim_forge_ui_owner.lua', '_cim_inventory_filter.lua', '_cim_command_owner.lua', '_cim_weave_economy.lua', '_cim_modded_loadout_owner.lua', '_cim_regression_checks.lua')
        }
        @{
            ...
            CeilingLines = 8114
            RequiredModules = @('_ct_combat_hooks.lua', '_ct_boon_registry.lua', '_ct_boon_preview_helpers.lua', '_ct_boss_grudge_marks.lua', '_ct_bot_weapon_chest_owner.lua', '_ct_command_owner.lua', '_ct_curse_lighting_owner.lua', '_ct_journey_difficulty_guard.lua', '_ct_pickup_spawn_owner.lua', '_ct_spawn_eligibility_owner.lua', '_ct_tab_panel_owner.lua', '_ct_weapon_trait_generation.lua', '_ct_regression.lua')
        }
        @{
            ...
            CeilingLines = 6058
            RequiredModules = @('_cwv_variant_catalog.lua', '_cwv_core_templates.lua', '_cwv_skin_registry.lua', '_cwv_illusion_families.lua', '_cwv_husk_path.lua', '_cwv_musket_runtime.lua', '_cwv_husk_residency_owner.lua', '_cwv_item_registration_owner.lua', '_cwv_regression_identity.lua', '_cwv_illusion_provenance.lua')
        }
        @{
