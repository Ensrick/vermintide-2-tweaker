return function(H, repo_root)
    ...
    H.test("CWV regression registration split preserves all checks and boundary", function()
        ...
        H.equal(names[33], "cwv_husk_transform_coverage")
        H.equal(names[34], "cwv_husk_stale_unit_and_postcondition")
        H.equal(names[35], "cwv_unit_bearing_variants_registered")
