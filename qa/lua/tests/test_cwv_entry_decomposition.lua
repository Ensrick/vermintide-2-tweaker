return function(H, repo_root)
    ...
    H.test("CWV regression registration split preserves all checks and boundary", function()
		...
		H.equal(names[45], "issue1186_outrider_projectile_reads_cloned_tunes")
		H.equal(names[46], "issue1188_wt_native_trollhammer_keeps_ammo")
		H.equal(names[47], "issue1320_outrider_projectile_unit_and_wire")
		H.equal(names[48], "cwv_unit_bearing_variants_registered")
		H.equal(names[49], "issue482_crafted_uuid_transform_consumers")
