return function(H, repo_root)
    ...
    H.test("CWV source fences hot join and blocks every thrown sender before encode", function()
        ...
        local projectile_shadow = assert(source:find("_om.javelin_gate.begin_ref_shadow(", transient_fence, true))
        ...
        local cleanup = assert(source:find("_remove_live_recovery_pickups()", require_peer, true))
