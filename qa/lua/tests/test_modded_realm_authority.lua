return function(H, repo_root)
    ...
    H.test("MP, both CIM streams, and GT-dev adopt the shared authority", function()
        ...
        local cim_public = read("/crafting_in_modded/scripts/mods/crafting_in_modded/crafting_in_modded.lua")
        local cim_dev = read("/crafting_in_modded_dev/scripts/mods/crafting_in_modded_dev/crafting_in_modded_dev.lua")
        local swap_public = read("/crafting_in_modded/scripts/mods/crafting_in_modded/illusion_swap.lua")
        local swap_dev = read("/crafting_in_modded_dev/scripts/mods/crafting_in_modded_dev/illusion_swap.lua")
        local forge_public = read("/crafting_in_modded/scripts/mods/crafting_in_modded/standard_forge.lua")
        local forge_dev = read("/crafting_in_modded_dev/scripts/mods/crafting_in_modded_dev/standard_forge.lua")
        local presentation = read("/crafting_in_modded_dev/scripts/mods/crafting_in_modded_dev/_cim_illusion_apply_presentation.lua")
        ...
        for _, cim in ipairs({ cim_public, cim_dev }) do
        ...
        H.truthy(presentation:find("deps.with_eac_off(func", 1, true) ~= nil)
