return function(H, repo_root)
    ...
    H.test("MP, CIM-dev, GT stable, and GT-dev adopt the shared authority", function()
        ...
        local canonical = read("/tools/shared_lib/_lib_modded_realm_authority.lua")
        local gt = read("/general_tweaker/scripts/mods/general_tweaker/_gt_level_control.lua")
        local gt_dev = read("/general_tweaker_dev/scripts/mods/general_tweaker_dev/_gt_level_control.lua")
        H.equal(read("/general_tweaker/scripts/mods/general_tweaker/" ..
            "_lib_modded_realm_authority.lua"), canonical)
        H.equal(read("/general_tweaker_dev/scripts/mods/general_tweaker_dev/" ..
            "_lib_modded_realm_authority.lua"), canonical)
        ...
        H.truthy(gt_dev:find("_lib_modded_realm_authority", 1, true) ~= nil)
        H.truthy(gt_dev:find("BackendGuard.reconcile", 1, true) ~= nil)
    end)
end
