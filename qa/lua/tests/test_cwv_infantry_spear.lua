return function(H, repo_root)
    ...
    H.test("CWV #620 moves shield-free spear meshes onto native Tuskgor Spear", function()
		...
		H.equal(source:find('item_key        = "cwv_es_infantry_spear"', 1, true), nil)
		H.truthy(source:find('if def.skin_only or def.cwv_retired then', 1, true))
		H.truthy(source:find('standalone Infantry Spear leaked into ItemMasterList', 1, true))
