return function(H, repo_root)
    ...
    H.test("CWV #596 Infantry Spear defaults exclude Grail Knight but WT can manage all careers", function()
    ...
    H.test("CWV #596 Infantry Spear owns the shield-family spear meshes without shields", function()
        ...
        H.truthy(source:find('left_hand_unit', 1, true))
        H.truthy(source:find('cwv_es_infantry_spear_skins', 1, true))
    end)
end
