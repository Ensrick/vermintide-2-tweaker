...
local suites = {
    ...
    "test_crt_profile_indicator_replay",
    ...
    "test_wt_history_patch_6_11_0",
    "test_wt_history_patch_6_11_2",
    ...
    "test_ct_progressive_modifier_runtime_owner",
    ...
    "test_cim_custom_illusion_composition",
    "test_issue48_finish",
    ...
    "test_cos_la_registration_owner",
    ...
    "test_gut_custom_stats",
    "test_gut_custom_stat_sync",
