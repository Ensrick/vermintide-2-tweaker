...
11 catalogs, 23 unique families, 35 family/state rows, 13 distinct states, and
231 scalar operations, with every exposed row classified as an adjacent delta
...
adversary. Under both PowerShell hosts it presents all eleven reproduction gates
for Patch 2.0.6, 2.0.9.1, 2.0.10, 3.1, 3.2, 4.1.1, 4.6, 5.2, 6.0, 6.6, and 6.8,
...
| `check_wt_history_source_checkout.ps1` | ✅ OK (2026-08-31) | Offline PS7/PS5.1 adversary proves that stale/partial Git trees visibly skip ordinary regeneration and fail closed under `-RequireSource` for the Patch 2.0.6, 2.0.9.1, 2.0.10, 3.1, 3.2, 4.1.1, 4.6, 5.2, 6.0, 6.6, and 6.8 gates. |
