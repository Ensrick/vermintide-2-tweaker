...
@{
  entries = @(
    ...
    @{ mod='ct_dev'; file='chaos_wastes_tweaker_dev/scripts/mods/chaos_wastes_tweaker_dev/chaos_wastes_tweaker_dev.lua'; needle='mod._ct_backfill_rank8_max_health = function(mh)'; literal=$true; polarity='present'; issueRef='#470'; note='Skulking Sorcerer rank-8 sparse-health backfill predicate remains exported for runtime regression coverage.' }
    @{ mod='ct_dev'; file='chaos_wastes_tweaker_dev/scripts/mods/chaos_wastes_tweaker_dev/chaos_wastes_tweaker_dev.lua'; needle='mod:hook_safe("MutatorHandler", "initialize_mutators"'; literal=$true; polarity='present'; minCount=1; maxCount=1; issueRef='#470'; note='the #470 backfill runs exactly once after mutator initialize, when the vanilla sparse MAX_HEALTH table has landed on the breed.' }
    @{ mod='ct_dev'; file='chaos_wastes_tweaker_dev/scripts/mods/chaos_wastes_tweaker_dev/chaos_wastes_tweaker_dev.lua'; needle='[ct:470] backfilled curse_mutator_sorcerer.max_health[8]=150'; literal=$true; polarity='present'; issueRef='#470'; note='in-game verification marker must stay searchable in console logs.' }
    @{ mod='ct_dev'; file='chaos_wastes_tweaker_dev/scripts/mods/chaos_wastes_tweaker_dev/chaos_wastes_tweaker_dev.lua'; needle='_rt_register("curse_sorcerer_rank8_backfill"'; literal=$true; polarity='present'; issueRef='#470'; note='runtime regression keeps proving sparse input mutates only [8] and full/nil inputs stay untouched.' }
