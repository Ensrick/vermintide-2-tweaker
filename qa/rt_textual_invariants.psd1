...
@{
  entries = @(
    ...
    @{ mod='cwv'; file='character_weapon_variants/scripts/mods/character_weapon_variants/character_weapon_variants.lua'; needle='parity:require_peer(peer_id)'; literal=$true; polarity='present'; minCount=2; issueRef='#424'; note='BUG_CLASSES 31: both transient-package loading and pre-GameSession object sync must synchronously disable Tuskgor Javelin behavior.' }
    @{ mod='cwv'; file='character_weapon_variants/scripts/mods/character_weapon_variants/character_weapon_variants.lua'; needle='_cwv424_actionutils_sender_guard_installed = true'; literal=$true; polarity='present'; issueRef='#424'; note='BUG_CLASSES 31: the dormant grenade-slot item has a separate ActionUtils lookup encoder that must stay guarded before any future re-enable.' }
    @{ mod='cwv'; file='character_weapon_variants/scripts/mods/character_weapon_variants/character_weapon_variants.lua'; needle='_cwv424_throw_gate_installed = true'; literal=$true; polarity='present'; issueRef='#424'; note='BUG_CLASSES 31: already-equipped Tuskgor Javelins must stop before projectile creation when peer capability is unproven.' }
    @{ mod='cwv'; file='character_weapon_variants/scripts/mods/character_weapon_variants/character_weapon_variants.lua'; needle='if rejected_peers[peer_id] then return false end'; literal=$true; polarity='present'; issueRef='#424'; note='BUG_CLASSES 31: cleanup failure must hold the joining peer outside GameSession because PeerStates ignores set_peer_synchronizing return values.' }
