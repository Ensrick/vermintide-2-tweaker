...
@{
  entries = @(
    ...
    @{ mod='ct_dev'; file='chaos_wastes_tweaker_dev/scripts/mods/chaos_wastes_tweaker_dev/chaos_wastes_tweaker_dev.lua'; needle='mod:network_register("ct_graph_snapshot_chunk"'; literal=$true; polarity='present'; issueRef='#1159'; note='the graph-snapshot RPC transport stays in the entry, NOT in the campaign-graph owner.' }
    ...
    @{ mod='ct_dev'; file='chaos_wastes_tweaker_dev/scripts/mods/chaos_wastes_tweaker_dev/chaos_wastes_tweaker_dev.lua'; needle='_ct_altar_reuse.reset_uses()'; literal=$true; polarity='present'; maxCount=1; issueRef='#1159'; note='run start still wipes the ledger exactly once, from the DeusRunController.setup_run hook.' }
    ...
    @{ mod='ct_dev'; file='chaos_wastes_tweaker_dev/scripts/mods/chaos_wastes_tweaker_dev/chaos_wastes_tweaker_dev.lua'; needle='mod._ct_chest_teleport_tick(dt)'; literal=$true; polarity='present'; maxCount=1; issueRef='#299'; note='the deferred rescue pass is still driven once per frame from the entry mod.update; without this reader the armed job never runs.' }
    ...
    # -- #1159: `_current_husk_wield` is REBOUND stack-style by the entry's husk
    ...
    @{ mod='cosmetics_tweaker'; file='cosmetics_tweaker/scripts/mods/cosmetics_tweaker/cosmetics_tweaker.lua'; needle='get_current_husk_wield = function() return _current_husk_wield end,'; literal=$true; polarity='present'; issueRef='#1159'; note='the rebound husk-wield context crosses the chunk boundary as a getter, never as an install-time value.' }
    ...
    @{ mod='cosmetics_tweaker'; file='cosmetics_tweaker/scripts/mods/cosmetics_tweaker/_cos_equipment_assembly.lua'; needle='local _current_husk_wield = nil'; literal=$true; polarity='absent'; issueRef='#1159'; note='the owner must never shadow the entry-owned husk-wield context with a declaration of its own.' }
