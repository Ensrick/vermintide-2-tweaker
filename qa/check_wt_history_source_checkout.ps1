# Offline adversarial fixture for all thirteen weapon-history source reproducers.
...
$checks = @(
    ...
    [pscustomobject]@{
        Name = 'Patch 2.0.9.1'
        Path = Join-Path $PSScriptRoot 'check_wt_history_patch_2_0_9_1_reproducibility.ps1'
    },
    [pscustomobject]@{
        Name = 'Patch 2.0.10'
        Path = Join-Path $PSScriptRoot 'check_wt_history_patch_2_0_10_reproducibility.ps1'
    },
    [pscustomobject]@{
        Name = 'Patch 3.1'
    ...
    [pscustomobject]@{
        Name = 'Patch 3.2'
        Path = Join-Path $PSScriptRoot 'check_wt_history_patch_3_2_reproducibility.ps1'
    },
    [pscustomobject]@{
        Name = 'Patch 4.1.1'
    ...
    [pscustomobject]@{
        Name = 'Patch 6.11.0'
        Path = Join-Path $PSScriptRoot 'check_wt_history_patch_6_11_0_reproducibility.ps1'
    },
    [pscustomobject]@{
        Name = 'Hotfix 6.11.2'
        Path = Join-Path $PSScriptRoot 'check_wt_history_patch_6_11_2_reproducibility.ps1'
    }
)
...
Write-Host '[check_wt_history_source_checkout:selftest] OK - all thirteen reproducers visibly skip an incomplete checkout and fail closed when source is required.' -ForegroundColor Green
exit 0
