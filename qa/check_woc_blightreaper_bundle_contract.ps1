...
$required = [ordered]@{
    ...
    '5FFDFE4D5728A9CD.lua'       = 'complete cross-career ability action matrix'
...
Write-Host "[check_woc_blightreaper_bundle_contract] OK - 18 compiled resources, Workshop=$status"
