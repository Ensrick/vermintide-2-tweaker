# Regression Checklist — material_hijack_patched

Subset of the monorepo [REGRESSION_CHECKLIST.md](../REGRESSION_CHECKLIST.md) — entries that apply to material_hijack_patched.
