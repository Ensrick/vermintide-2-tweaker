...
-- duplicate-hook collision — audited against the rest of gt). Bundled here
...
--
-- Extracted from general_tweaker.lua (Phase 3 refactor, no behavior change).
...
-- risk within gt: grepped -- nothing else hooks these (Class, method) pairs
...
-- clear it. NO duplicate-hook risk: grepped gt — nothing else hooks
...
-- enough. NO duplicate-hook risk: grepped gt — nothing else hooks these
