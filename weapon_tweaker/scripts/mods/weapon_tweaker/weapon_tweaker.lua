...
local MOD_VERSION = "0.12.277-beta"
...
local _weapon_grip_offsets = {
    ...
    wh_crossbow = { es_ = {0, 0.100, 0.025, hand = "left"} },  -- #701 Kruber: LEFT hand only (crossbows.lua:258-259); rationale in OFFSETS.md
...
mod:hook("MenuWorldPreviewer", "_spawn_item_unit", function(func, self, unit, slot_type, item_template, attachment_node_linking, scene_graph_links, material_settings_name, skip_wield_anim)
    ...
    local fake_slot = (item_template and item_template.left_hand_unit and not item_template.right_hand_unit) and { left_unit_3p = unit } or { right_unit_3p = unit }  -- #701: left-only templates spawn one LEFT 3P unit; blanket right_unit_3p key made hand="left" entries skip the preview
