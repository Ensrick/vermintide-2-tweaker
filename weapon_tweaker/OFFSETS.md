...
1. Set the value in `_weapon_grip_offsets[weapon_key] = { <career_prefix>_ = {x, y, z[, hand="right"|"left"]} }`.
   `hand="left"` entries DO reach the inventory preview: since v0.12.276-beta the
