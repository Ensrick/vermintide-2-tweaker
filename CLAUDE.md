...
| character_dialogue | `character_dialogue` | 3765055148 (private) | single | Source-generated dialogue catalogue, sparse per-line eligibility overrides, and local preview transport. Tweaker: GUI dev owns the Dialogue tab renderer; Character Dialogue owns persistence and natural-selection policy. See Issue #605. |
