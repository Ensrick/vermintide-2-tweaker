> [!WARNING]
> ⚠ **SUPERSEDED** — this snapshot is from 2026-04-25 (28 days old).
...
> or move the doc to `_archive/audits/2026-04-25/`.
> ⚠️ **Stale snapshot — superseded by [`AUDIT_2026_05_21.md`](./AUDIT_2026_05_21.md)**
>
> This document was the audit-of-record on 2026-05-01. The codebase has changed substantially since. Use this file for HISTORY and CONTEXT only. For current state, see the 2026-05-21 master audit.
