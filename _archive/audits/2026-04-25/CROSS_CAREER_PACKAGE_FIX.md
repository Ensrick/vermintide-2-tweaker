...
>
> ⚠️ Theory in this doc was later disproven — see [`AUDIT_2026_05_21.md`](./AUDIT_2026_05_21.md) for current cross-career package handling.
>
> Original analysis dated 2026-04 (pre-2026-05-01 VMB migration). The root cause was traced to `career_name = nil` at spawn time, NOT a package-loading issue. Some ideas (persisting loadout_cache, hooking get_loadout_item early) may still be useful but the diagnostic frame is wrong. Use this file for HISTORY and CONTEXT only.
