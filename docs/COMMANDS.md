...
```
*(partial gut audit added 2026-06-24 alongside the in-mission inventory migration; refreshed 2026-07-14 for #272. The retired `/reload_config` command is intentionally absent because retail exposes no file-read channel.)*
...
probe_hat, probe_cosmetics, cos_offhand_name_inventory, frames_status, la_offhand_dump,
...
```
woc_regression_test, woc_audio_contract, woc_audio_probe, woc_pose, woc_pose_reset, woc_pose_audit,
