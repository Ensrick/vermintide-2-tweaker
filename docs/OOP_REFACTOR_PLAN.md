...
| Cosmetics | Partial | Four phase slices plus runtime/wire, exact-item offhand session-state, modded-illusion-swap, and magic-family visibility-policy extraction; entry ceiling is machine-owned in `qa/decomposition_contracts.psd1` | #504 / #2 |
