...
2. The death reaction ticks; `ai_default_unit_update` pushes the corpse onto the death watch (death_reactions.lua:405-406) -> `push_unit_to_death_watch_list` (unit_spawner.lua:88) trims corpse extensions (:100-107).
