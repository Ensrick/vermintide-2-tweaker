...
# authority gate; local deployment requires its separate hosted receipt gate.
# Remote deployment and updater/recovery consumption remain tracked-only.
# Producer metadata grants no restore authority.
