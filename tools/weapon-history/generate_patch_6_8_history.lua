-- Generate the bounded Patch 6.8 history catalog for Tweaker: Weapons (#1436).
--
-- Usage:
--   lua5.1 generate_patch_6_8_history.lua <source-repo> <evidence-dir> <output.lua>
--
-- The operation set comes from the adjacent 6.7.2 -> 6.8.1 source diff. The
...
local function validate_snapshot(snapshot, rehydrated, catalog)
    ...
    assert(operation.unset == false and operation.value == 1.45,
        "historical range value drift")
    if rehydrated then
        assert(operation.expected_current_unset == false
                and operation.expected_current == 1.55,
            "current range guard drift")
    end
    return operation
end
...
file:write("-- AUTO-GENERATED by tools/weapon-history/generate_patch_6_8_history.lua; DO NOT HAND-EDIT.\n")
