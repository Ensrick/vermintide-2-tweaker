...
#>
    ...
    ReceiptFamilyOverrides = @(
        ...
        @{
            ...
            ModTrees=@{crt='ad8f0ba8fdcc497a4d5d8198f1a8e94a666aede5'}
        ...
        @{
            ...
            ModTrees=@{wt='d3006f172eca7452db24423aeb1a70b131316631';wt_dev='3f261ee1ad6727f803c90431e4502fb5429ec04a'}
            SourcesByMod=@{
        ...
        @{
            ...
            ModTrees=@{character_weapon_variants='39959dfefa5b16564d7ecdef36957d5b485c6d03'}
        ...
        @{
            ...
            ModTrees=@{ct_dev='d17f7cd1fc2ddb2337784fe7a728d9bf96fc6c71'}
        ...
        @{
            ...
            ModTrees=@{gut_dev=@('1c2a9d0edde731e1a5f944e66704761a2ee0e7b6')}
        ...
        @{
            Marker='[cwv:1107]';ModId='character_weapon_variants';ModTrees=@{character_weapon_variants='39959dfefa5b16564d7ecdef36957d5b485c6d03'}
        ...
        @{
            Marker='[gut:938]';ModId='gut_dev';ModTrees=@{gut_dev=@('1c2a9d0edde731e1a5f944e66704761a2ee0e7b6')}
        ...
        @{
            Marker='[ct:919]';ModId='ct_dev';ModTrees=@{ct_dev='d17f7cd1fc2ddb2337784fe7a728d9bf96fc6c71'}
        ...
        @{
            Marker='[cwv:786]';ModId='character_weapon_variants';ModTrees=@{character_weapon_variants='39959dfefa5b16564d7ecdef36957d5b485c6d03'}
        ...
        @{
            Marker='[cwv:645]';ModId='character_weapon_variants';ModTrees=@{character_weapon_variants='39959dfefa5b16564d7ecdef36957d5b485c6d03'}
            SourcesByMod=@{character_weapon_variants='character_weapon_variants/scripts/mods/character_weapon_variants/_cwv_combat_styles.lua'}
        ...
        @{
            Marker='[ct:571-native]';ModId='ct_dev';ModTrees=@{ct_dev='d17f7cd1fc2ddb2337784fe7a728d9bf96fc6c71'}
        ...
        @{
            Marker='[wt:388]';ModIds=@('wt','wt_dev');ModTrees=@{wt='d3006f172eca7452db24423aeb1a70b131316631';wt_dev='3f261ee1ad6727f803c90431e4502fb5429ec04a'}
        ...
        @{
            Marker='[cwv:317]';ModId='character_weapon_variants';ModTrees=@{character_weapon_variants='39959dfefa5b16564d7ecdef36957d5b485c6d03'}
        ...
        @{
            Marker='[ct:288]';ModId='ct_dev';ModTrees=@{ct_dev='d17f7cd1fc2ddb2337784fe7a728d9bf96fc6c71'}
        ...
        @{
            Marker='[gut:250]';ModId='gut_dev';ModTrees=@{gut_dev=@('1c2a9d0edde731e1a5f944e66704761a2ee0e7b6')}
        ...
        @{
            Marker='[ct:141]';ModId='ct_dev';ModTrees=@{ct_dev='d17f7cd1fc2ddb2337784fe7a728d9bf96fc6c71'}
        ...
        @{
            Marker='[gut:257]';ModId='gut_dev';ModTrees=@{gut_dev=@('1c2a9d0edde731e1a5f944e66704761a2ee0e7b6')}
        ...
        @{
            Marker='[gut:245]';ModId='gut_dev';ModTrees=@{gut_dev=@('1c2a9d0edde731e1a5f944e66704761a2ee0e7b6')}
    ...
    ReceiptRouteOverrides = @(
        @{
            ModId='gut_dev'; ModTrees=@('1c2a9d0edde731e1a5f944e66704761a2ee0e7b6')
            Source='gui_tweaker_dev/scripts/mods/gui_tweaker_dev/_gut_camera.lua'
            Marker='[gut:209]'
            Signature='[gut:209] %s | effect=%s id=%s tp=%s callsite=%s%s'
            Bound='at most 120 particle lifecycle rows per loaded GUI Dev module generation; the shared ledger latches its cap before any later hook event can emit'
            EmitterAnchors=@(
                'pcall(printf, "[gut:209] %s | effect=%s id=%s tp=%s callsite=%s%s"'
            )
            GuardAnchors=@(
                '_SPLedger.row_allowed(_p209_state)'
                'if not allowed then return end'
                @{
                    Source='gui_tweaker_dev/scripts/mods/gui_tweaker_dev/_gut_screen_particle_ledger.lua'
                    Tokens=@('function','Ledger','.','row_allowed','(','state',')','if','state','.','capped','then','return','false',',','false','end','state','.','rows','=','state','.','rows','+','1','if','state','.','rows','>=','Ledger','.','MAX_ROWS','then','state','.','capped','=','true','return','true',',','true','end','return','true',',','false','end')
                }
            )
        }
        @{
            ModId='ct_dev'; ModTree='d17f7cd1fc2ddb2337784fe7a728d9bf96fc6c71'
        ...
        @{
            ModId='character_weapon_variants'; ModTree='39959dfefa5b16564d7ecdef36957d5b485c6d03'
        ...
        @{
            ModId='crt'; ModTree='ad8f0ba8fdcc497a4d5d8198f1a8e94a666aede5'
