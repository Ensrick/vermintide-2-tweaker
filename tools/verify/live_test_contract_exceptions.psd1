...
#>
    ...
    ReceiptFamilyOverrides = @(
        ...
        @{
            ...
            ModTrees=@{wt='04dcd9b6665adf2bbc529f15b888a81ebbde1aed';wt_dev='2efe23f7314578402a61ab164008110209e0b1d1'}
            SourcesByMod=@{
        ...
        @{
            Marker='[wt:388]';ModIds=@('wt','wt_dev');ModTrees=@{wt='04dcd9b6665adf2bbc529f15b888a81ebbde1aed';wt_dev='2efe23f7314578402a61ab164008110209e0b1d1'}
    ...
    ReceiptRouteOverrides = @(
        ...
        @{
            ModId='wt_dev'; ModTree='2efe23f7314578402a61ab164008110209e0b1d1'
