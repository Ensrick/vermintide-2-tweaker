...
@{
    ...
    ReceiptFamilyOverrides = @(
        ...
        @{
            ...
            ModTrees=@{wt='d598b0f1b2428f878f360953978655f9ad13a7ad';wt_dev='520452cbb957bfcae8927abe33ba585c2e1599d0'}
            SourcesByMod=@{
        ...
        @{
            Marker='[wt:388]';ModIds=@('wt','wt_dev');ModTrees=@{wt='d598b0f1b2428f878f360953978655f9ad13a7ad';wt_dev='520452cbb957bfcae8927abe33ba585c2e1599d0'}
    ...
    ReceiptRouteOverrides = @(
        ...
        @{
            ModId='wt_dev'; ModTree='520452cbb957bfcae8927abe33ba585c2e1599d0'
