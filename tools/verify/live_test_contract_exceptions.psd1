...
@{
    ...
    ReceiptFamilyOverrides = @(
        ...
        @{
            ...
            ModTrees=@{wt='57b434184cce7585857b0d586bbd9d64b53ed098';wt_dev='22776c6602b53977d2046a64d675585cc127d7e3'}
            SourcesByMod=@{
        ...
        @{
            Marker='[wt:388]';ModIds=@('wt','wt_dev');ModTrees=@{wt='57b434184cce7585857b0d586bbd9d64b53ed098';wt_dev='22776c6602b53977d2046a64d675585cc127d7e3'}
    ...
    ReceiptRouteOverrides = @(
        ...
        @{
            ModId='wt_dev'; ModTree='22776c6602b53977d2046a64d675585cc127d7e3'
