...
@{
    ...
    ReceiptFamilyOverrides = @(
        ...
        @{
            ...
            ModTrees=@{wt='00d3dc08555444921bb932ced6a904440a98a441';wt_dev='f9ebf0c8cd38594415407c45874dbce7df83a2fa'}
            SourcesByMod=@{
        ...
        @{
            Marker='[wt:388]';ModIds=@('wt','wt_dev');ModTrees=@{wt='00d3dc08555444921bb932ced6a904440a98a441';wt_dev='f9ebf0c8cd38594415407c45874dbce7df83a2fa'}
    ...
    ReceiptRouteOverrides = @(
        ...
        @{
            ModId='wt_dev'; ModTree='f9ebf0c8cd38594415407c45874dbce7df83a2fa'
