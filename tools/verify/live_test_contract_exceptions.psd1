...
#>
    ...
    ReceiptFamilyOverrides = @(
        ...
        @{
            ...
            ModTrees=@{crt='a054ad0aa94f908db3f1cdf22c98aecf3337ba4f'}
        ...
        @{
            ...
            ModTrees=@{character_weapon_variants='234fc832e039c48d4193185dcb3b12efd9a664e1'}
        ...
        @{
            ...
            ModTrees=@{ct_dev='7fe90660c9b666a94c06523ad74f1646da1c329b'}
        ...
        @{
            ...
            ModTrees=@{gut_dev=@('7301a0daa96da1991628b2ba2267936f0e679279')}
        ...
        @{
            Marker='[cwv:1107]';ModId='character_weapon_variants';ModTrees=@{character_weapon_variants='234fc832e039c48d4193185dcb3b12efd9a664e1'}
        ...
        @{
            Marker='[gut:938]';ModId='gut_dev';ModTrees=@{gut_dev=@('7301a0daa96da1991628b2ba2267936f0e679279')}
        ...
        @{
            Marker='[ct:919]';ModId='ct_dev';ModTrees=@{ct_dev='7fe90660c9b666a94c06523ad74f1646da1c329b'}
        ...
        @{
            Marker='[cwv:786]';ModId='character_weapon_variants';ModTrees=@{character_weapon_variants='234fc832e039c48d4193185dcb3b12efd9a664e1'}
        ...
        @{
            Marker='[cwv:645]';ModId='character_weapon_variants';ModTrees=@{character_weapon_variants='234fc832e039c48d4193185dcb3b12efd9a664e1'}
            SourcesByMod=@{character_weapon_variants='character_weapon_variants/scripts/mods/character_weapon_variants/_cwv_combat_styles.lua'}
        ...
        @{
            Marker='[ct:571-native]';ModId='ct_dev';ModTrees=@{ct_dev='7fe90660c9b666a94c06523ad74f1646da1c329b'}
        ...
        @{
            Marker='[cwv:317]';ModId='character_weapon_variants';ModTrees=@{character_weapon_variants='234fc832e039c48d4193185dcb3b12efd9a664e1'}
        ...
        @{
            Marker='[ct:288]';ModId='ct_dev';ModTrees=@{ct_dev='7fe90660c9b666a94c06523ad74f1646da1c329b'}
        ...
        @{
            Marker='[gut:250]';ModId='gut_dev';ModTrees=@{gut_dev=@('7301a0daa96da1991628b2ba2267936f0e679279')}
        ...
        @{
            Marker='[ct:141]';ModId='ct_dev';ModTrees=@{ct_dev='7fe90660c9b666a94c06523ad74f1646da1c329b'}
        ...
        @{
            Marker='[gut:257]';ModId='gut_dev';ModTrees=@{gut_dev=@('7301a0daa96da1991628b2ba2267936f0e679279')}
        ...
        @{
            Marker='[gut:245]';ModId='gut_dev';ModTrees=@{gut_dev=@('7301a0daa96da1991628b2ba2267936f0e679279')}
    ...
    ReceiptRouteOverrides = @(
        @{
            ModId='gut_dev'; ModTrees=@('7301a0daa96da1991628b2ba2267936f0e679279')
        ...
        @{
            ModId='ct_dev'; ModTree='7fe90660c9b666a94c06523ad74f1646da1c329b'
        ...
        @{
            ModId='character_weapon_variants'; ModTree='234fc832e039c48d4193185dcb3b12efd9a664e1'
        ...
        @{
            ModId='cosmetics_tweaker'; ModTrees=@('9317ea3ed13bc639a5348a1ae475ec50b14e489e')
        ...
        @{
            ModId='crt'; ModTree='a054ad0aa94f908db3f1cdf22c98aecf3337ba4f'
        ...
        @{
            ModId='cim_dev'; ModTree='61d7af3b178d3efc21fb069cacdc589a37afb775'
        ...
        @{
            ModId='cosmetics_tweaker'; ModTree='9317ea3ed13bc639a5348a1ae475ec50b14e489e'
