...
@{
    ...
    ReceiptFamilyOverrides = @(
        ...
        @{
            ...
            ModTrees=@{wt='3d5551e4af4ea249d61ed4ed28d2eba5de612a58';wt_dev='6b31b764059f4877b790791bd424cf9b6df50860'}
            SourcesByMod=@{
        ...
        @{
            Marker='[wt:388]';ModIds=@('wt','wt_dev');ModTrees=@{wt='3d5551e4af4ea249d61ed4ed28d2eba5de612a58';wt_dev='6b31b764059f4877b790791bd424cf9b6df50860'}
    ...
    ReceiptRouteOverrides = @(
        ...
        @{
            ModId='wt_dev'; ModTree='6b31b764059f4877b790791bd424cf9b6df50860'
