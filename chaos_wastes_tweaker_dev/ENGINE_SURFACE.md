...
10,316 physical lines, with the boon runtime split into `_ct_boon_balance.lua`,
`_ct_boon_registry.lua`, and `_ct_meta_trait_boons.lua`, weapon generation owned
by `_ct_weapon_trait_generation.lua`, and the bulk of the
