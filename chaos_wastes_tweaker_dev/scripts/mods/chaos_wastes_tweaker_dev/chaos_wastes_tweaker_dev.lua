...
mod:dofile("scripts/mods/chaos_wastes_tweaker_dev/_ct_run_creation_owner")(mod, {
    ...
    starting_coins_applied_for_run = function(value)
        if value ~= nil then
            _starting_coins_applied_for_run = value
        end
...
mod:dofile("scripts/mods/chaos_wastes_tweaker_dev/_ct_pickup_population_owner")(mod, {
    ...
    set_career_exclusive_denial_counts   = function(value) _career_exclusive_denial_counts = value end,
    set_career_exclusive_logged_this_run = function(value) _career_exclusive_logged_this_run = value end,
})
