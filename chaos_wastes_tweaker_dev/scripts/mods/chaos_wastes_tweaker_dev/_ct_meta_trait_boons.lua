-- _ct_meta_trait_boons.lua — Trait boons and peer-parity runtime hooks.
--
-- Owns CT-authored trait boon registration, host-dependent resynchronization,
-- peer-parity gating, and bounded trait/buff hooks. Meta-boon ownership is
-- delegated synchronously to `_ct_meta_boon_owner.lua`.
