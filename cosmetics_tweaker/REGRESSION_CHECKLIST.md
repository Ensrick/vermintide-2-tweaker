...
| Commands | `_cos_diag_glow.lua` owns six wielded-material diagnostic commands and both bounded tick functions; `_cos_la_commands.lua` owns six LA diagnostic commands. Neither module owns a hook, RPC, or lifecycle callback. |
