...
latest bounded slice moved the five glow-picker host-window hooks and two manual
  ...
  Cosmetics is now below the 2,500-line hard limit; the LA-bridge + remote-husk
  integration, remaining customization UI, and live weapon render hooks remain in
  the entry pending the 1,500-line completion target. The preview owner calls the
