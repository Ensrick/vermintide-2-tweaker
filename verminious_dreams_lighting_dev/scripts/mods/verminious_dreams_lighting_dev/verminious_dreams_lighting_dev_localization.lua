...
return {
    ...
    enable_dlc_termite_1         = en("[untested] The Forsaken Temple"),
    ...
    enable_dlc_termite_2         = en("[untested] Devious Delvings"),
    ...
    enable_dlc_termite_3         = en("[untested] The Well of Dreams"),
    ...
    enable_cw_curse_adjust         = en("[untested] Chaos Wastes curse adjustment"),
