# Regression Checklist — verminious_dreams_lighting

Subset of the monorepo [REGRESSION_CHECKLIST.md](../REGRESSION_CHECKLIST.md) — entries that apply to verminious_dreams_lighting.
