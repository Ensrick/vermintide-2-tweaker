...
Require ($entry -match 'ISSUE221_UMBRELLA_AUDIT_ARMED\s*=\s*true') '#221 umbrella-audit armed marker missing'
...
Require ($regression -match '_rt_register\("issue221_umbrella_audit_armed"') 'runtime #221 audit check missing'
