return {
    ...
    rework_wh_zealot_ability_green_to_thp               = { en = "Rework: Ability — convert green health to THP" },
    rework_wh_zealot_ability_green_to_thp_description   = { en = "Every time the Zealot activates Holy Fervour, all of his permanent (green) health is converted into temporary (white) health. Synergizes with Zealot's missing-health damage bonus passive — a full-HP activation drops him to 0 permanent HP, maximizing the passive's damage multiplier while the THP buffer keeps him alive (and decays normally). Existing THP is preserved; conversion fires once per ability use." },
